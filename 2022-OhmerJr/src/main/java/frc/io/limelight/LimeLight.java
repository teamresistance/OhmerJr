...
public class LimeLight {
    ...
    private static double ledmode = 0;  //0=Off, 1=All On, 2=left on? 3=right on?
    private static double cammode = 0, pipeline = 1;
    private static boolean ll_LED_On = true; // Turns green light on and off so Robert is not blinded - AS
    ...
    public static void update() {
        ...
        switch (state) {
            ...
            case 1:
                ledmode = SmartDashboard.getNumber("LL/led mode", ledmode);
                setLED();
                sdbUpdate();
                break;
            default:
